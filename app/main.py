"""
NutriAI Health Service - Main Application
"""
import logging
...
async def health():
    ...
    return {"service": "health-service", "status": "healthy" if db_ok else "degraded", "database": "connected" if db_ok else "disconnected", "timestamp": datetime.now(timezone.utc).isoformat()}
